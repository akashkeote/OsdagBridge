...
""" + (r"""\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{""" + input_dict.get('_material_summary_fig', '') + r"""}
\caption{Material Quantities Summary}
\end{figure}
""" if input_dict.get('_material_summary_fig') else "") + r"""
"""
